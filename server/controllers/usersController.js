...
//       const setnewusersspass = await User.findByIdAndUpdate(
//         { _id: id },
//         { password: newpassword }
//       );
//       setnewusersspass.save();
//       res.status(201).json({ status: 201, setnewusersspass });
//     } else {
//       res.status(401).json({ status: 401, message: "user not exist" });
//     }
//   } catch (error) {
...
//get applied jobs along with the status of the job
